<%@ Page Title="Laboratorio 4" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Lab4.aspx.vb" Inherits="LabManager.Lab4" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="container text-center mt-4">
        <h1 class="display-4 fw-bold text-primary">Laboratorio 4</h1>
    ...
    <div class="container my-4">
        <div class="row justify-content-center text-center">
            ...
            <!-- Dropdown para seleccionar computadora -->
            <div class="col-md-auto mb-3">
    ...
    <asp:SqlDataSource ID="DS_Lab4" runat="server" ConnectionString="<%$ ConnectionStrings:CS_LabManager %>"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="4" Name="id_laboratorio" Type="Int32" />
            <asp:ControlParameter ControlID="DdlComputadora" Name="id_computadora" PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>

    <asp:GridView ID="GV_Lab4" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="id_asignacion" DataSourceID="DS_Lab4" CssClass="table table-bordered table-hover table-responsive text-center table-striped" Visible="false">
        <Columns>
            ...
            <asp:BoundField DataField="fecha_instalacion" HeaderText="Fecha de Instalacion" />
            <asp:BoundField DataField="nombre_programa" HeaderText="Programa" />
            <asp:BoundField DataField="version_programa" HeaderText="Version" />
    ...
    <asp:SqlDataSource ID="DS_Lab4PC" runat="server" ConnectionString="<%$ ConnectionStrings:CS_LabManager %>"
    ...
    <asp:GridView ID="GV_PCsLab4" runat="server" AutoGenerateColumns="False" DataKeyNames="id_computadora,id_componente" DataSourceID="DS_Lab4PC" CssClass="table table-bordered table-hover table-responsive text-center table-striped" AllowPaging="True" Visible="false">
        <Columns>
            <asp:BoundField DataField="id_computadora" HeaderText="#" />
            <asp:BoundField DataField="nombre_equipo" HeaderText="Equipo" />
            <asp:BoundField DataField="id_laboratorio" HeaderText="Laboratorio" />
            <asp:BoundField DataField="id_componente" HeaderText="Componente" />
