<%@ Page Title="Lab4" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Lab4.aspx.vb" Inherits="LabManager.Lab4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="DS_Lab4PC" runat="server" ConnectionString="<%$ ConnectionStrings:CS_LabManager %>" SelectCommand="SELECT * FROM [vw_ComponentesPorComputadora] WHERE ([id_laboratorio] = @id_laboratorio)">
        <SelectParameters>
            <asp:Parameter DefaultValue="4" Name="id_laboratorio" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
