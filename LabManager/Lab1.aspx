<%@ Page Title="Laboratorio 1" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Lab1.aspx.vb" Inherits="LabManager.Lab1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="container text-center mt-4">
        <h1 class="display-4 fw-bold text-primary">Laboratorio 1</h1>
    ...
    <asp:GridView ID="GV_Lab1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="id_asignacion" DataSourceID="DS_Lab1" CssClass="table table-bordered table-hover table-responsive text-center table-striped" Visible="false">
        <Columns>
