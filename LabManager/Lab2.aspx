<%@ Page Title="Lab2" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Lab2.aspx.vb" Inherits="LabManager.Lab2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="DS_Lab2PC" runat="server" ConnectionString="<%$ ConnectionStrings:CS_LabManager %>" SelectCommand="SELECT * FROM [vw_ComponentesPorComputadora] WHERE ([id_laboratorio] = @id_laboratorio)">
        <SelectParameters>
            <asp:Parameter DefaultValue="2" Name="id_laboratorio" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
