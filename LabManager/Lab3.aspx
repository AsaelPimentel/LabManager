...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="DS_Lab3PC" runat="server" ConnectionString="<%$ ConnectionStrings:CS_LabManager %>" SelectCommand="SELECT * FROM [vw_ComponentesPorComputadora] WHERE ([id_laboratorio] = @id_laboratorio)">
        <SelectParameters>
            <asp:Parameter DefaultValue="3" Name="id_laboratorio" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
