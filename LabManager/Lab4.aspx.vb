...
Public Class Lab4
    ...
    Private Sub CargarComputadoras()
        ...
        Using con As New SqlConnection(cs)
            Dim cmd As New SqlCommand("SELECT id_computadora, nombre_equipo FROM Computadoras WHERE id_laboratorio = 4", con)
            con.Open()
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            CargarComputadoras()
            GV_Lab4.Visible = False
            GV_PCsLab4.Visible = False
        End If
    End Sub
    ...
    Private Sub MostrarGrids()
        ...
        If vistaSeleccionada = "1" Then
            GV_Lab4.Visible = True
            GV_Lab4.DataBind()
        ElseIf vistaSeleccionada = "2" Then
            GV_PCsLab4.Visible = True
            GV_PCsLab4.DataBind()
        End If
    End Sub
